/**
 * One physical card copy, enriched with Scryfall data. Canonical shape lives
 * in `@spellcontrol/binder-routing` (the routing engine's own card type) —
 * re-exported here rather than hand-copied so frontend/backend/routing-engine

 ...
 *
 * Lean by default: a wrap of "name ×N" chips (N = how many deck cards make that
 * token). Tap a chip to reveal what it is and which cards produce it. Built on
 * the shared Modal primitive (backdrop / Escape / scroll-lock / focus restore).
 */
export function DeckTokensSheet({
  ...
  return (
    <Modal onClose={onClose} labelledBy={titleId} className="deck-tokens-sheet">

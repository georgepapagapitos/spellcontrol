...
export interface GamePlayer {
  ...
  /**
   * Player-chosen panel color override. One of W/U/B/R/G/M/C, or null to
   * fall back to the deck's color identity. Set via the per-seat color
   * picker so two friends both running mono-red decks aren't stuck with
   * identical panels.
   */

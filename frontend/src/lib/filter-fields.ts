...
export const FILTER_FIELDS: FilterFieldSpec[] = [
  {
    ...
    label: 'Type line',
    group: 'Identity',
    hint: 'Matches anywhere in the whole type line: "Legendary Creature", "Basic Land".',
  ...
  },
  {
    ...
    label: 'Mana cost',
    group: 'Cost',
    hint: 'The exact symbols, like {2}{G}{W}.',
  ...
  },
  {
    ...
    label: 'Oracle tags',
    group: 'Text',
    hint: "Scryfall's tagged concepts. More precise than searching the text.",

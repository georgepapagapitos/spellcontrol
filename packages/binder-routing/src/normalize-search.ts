/**
 * Shared name-normalizer for every card search surface — client and server.
 *
 ...
 *    matching a typed "urzas"). Straight AND curly — mobile keyboards emit the
 *    curly one, so folding only the straight form silently misses those queries.
